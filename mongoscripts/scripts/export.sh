...
#-- Unigrams---
mongoexport --db $3 --collection Unigrams_with_freq --csv --fieldFile "$1/fields_unigrams.txt" --out $2/output/unigram/unigrams_freq.csv
mongoexport --db $3 --collection Food_Unigrams --csv --fieldFile "$1/fields_unigrams.txt" --out $2/output/unigram/Food_Unigrams.csv
mongoexport --db $3 --collection Service_Unigrams --csv --fieldFile "$1/fields_unigrams.txt" --out $2/output/unigram/Service_Unigrams.csv
mongoexport --db $3 --collection Price_Unigrams --csv --fieldFile "$1/fields_unigrams.txt" --out $2/output/unigram/Price_Unigrams.csv
mongoexport --db $3 --collection Ambiance_Unigrams --csv --fieldFile "$1/fields_unigrams.txt" --out $2/output/unigram/Ambience_Unigrams.csv
mongoexport --db $3 --collection Deal_Unigrams --csv --fieldFile "$1/fields_unigrams.txt" --out $2/output/unigram/Deals_Unigrams.csv
# -- bigrams----
