...
# mongoimport --db yelp --collection features --type csv --file /home/saini/Dropbox/src/Features/unigrams_final.csv --fieldFile "./mongoscripts/scripts/fields_features.txt"
